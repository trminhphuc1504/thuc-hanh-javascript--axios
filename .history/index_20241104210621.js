...
// return trong hàm async luôn luôn là  1 Promise
const allTask = async ()=>{
    try{
        // thành công
...
const result1 = allTask().then((data)=>{
    console.log('data: ', data);
})
...
// AJAX:
// Cho phép thay đổi UI ko cần load lại trang web

// XMLHTTPRequest, fetch, thư viện axios
// REST APIs
// 1 chuẩn xây dựng API dựa trên chuẩn REST

// API có đầy đủ những phương thức:
// GET: Dùng lấy dữ liệu từ server
// POST: Thêm mới dữ liệu
// PUT, PACTH: Chỉnh sửa dữ liệu